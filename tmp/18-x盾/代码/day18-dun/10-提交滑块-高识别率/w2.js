...
(function() {
    ...
    , function(Q, z) {
        ...
        Q[Cf(0x208)] = F;
        window.unique2DArray = F["unique2DArray"];
    }
    , function(Q, z, R) {
        var QF = CZ;
        function F(S) {
...
var atom_trace_data = JSON.parse(process.argv[2]);
var tmp = window.unique2DArray(atom_trace_data,0x2);
var w2 = window.Y(tmp);
var w2_string = w2.join(",")
console.log(w2_string);